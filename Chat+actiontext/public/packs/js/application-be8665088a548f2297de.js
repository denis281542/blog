...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("RoomChannel", {
  connected: function connected() {
    console.log('yiha, we are ready!'); // Called when the subscription is ready for use on the server
  },
  disconnected: function disconnected() {// Called when the subscription has been terminated by the server
  },
  received: function received(data) {
    console.log(data.content); // Called when there's incoming data on the websocket for this channel
  }
});
...
/******/ });
//# sourceMappingURL=application-be8665088a548f2297de.js.map